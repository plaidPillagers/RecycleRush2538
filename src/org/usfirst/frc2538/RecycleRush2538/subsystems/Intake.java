...
public class Intake extends Subsystem {
    ...
    public boolean okayContainer() {
    	if (!containerSwitch.get()) {
			return true;
		}
		return false;
    }
  ...
  //these methods insure correct booleans depending on how the switch is set
    ...
    public void limitSwitchIntake() {
    	...
    	if (isToteConfig) {
    		//waiting on active intake mechanism to be decided
			intakeTote();
		}
    	else {
			intakeContainer();
