...
public class DriveSystem extends Subsystem {
    ...
    public void homemadeMecanum() {
    	...
    	double joystickX = circularXVal;
    	double joystickY = circularYVal;
	...
	public void makeWheels() {
    	...
    	rightFrontMec = new MecanumSpeedConrtoller(rightFront, -1., 1., frontCompensation, false);
    	leftRearMec = new MecanumSpeedConrtoller(leftRear, -1., 1., aftCompensation, false);
    	rightRearMec = new MecanumSpeedConrtoller(rightRear, 1., 1., aftCompensation, false);
