...
public class DriveSystem extends Subsystem {
    ...
    // RangeFinder forwardRangeFinder = new RangeFinder(0x04);
    ...
    private final double GYROZONEONEVOLTAGE = 0;
    private final double GYROZONETWOVOLTAGE = .25;
    private final double GYROZONETHREEVOLTAGE = .5;
    ...
    */
    ...
    public boolean centerAngle() {
    	...
    	if (Math.abs(gyroAngle) < ANGLEMARGIN) {
    		...
    		autoTwist(GYROZONETWOVOLTAGE, directionToMove);
    		return false;
    	}
    	else{
    		autoTwist(GYROZONETHREEVOLTAGE, directionToMove);
    		return false;
    	}
    }
    
    public boolean centerToAngle(double angleToMoveTo) {
    	double gyroAngle = gyro.getAngle() - angleToMoveTo;
    	int directionToMove = (gyroAngle < 0.0)? 1 : -1;
    	if (Math.abs(gyroAngle) < ANGLEMARGIN) {
			return true;
		}
