...
public class DriveSystem extends Subsystem {
    ...
    Ultrasonic portRangeFinder = RobotMap.driveSystemportRangeFinder;
    Ultrasonic starboardRangeFinder = RobotMap.driveSystemstarboardRangeFinder;
    ...
    Ultrasonic forwardRangeFinder = RobotMap.driveSystemforwardRangeFinder;
    ...
    private void displayDriveInfo(Joystick driveStick) {
    	...
    	double leftDistance = portRangeFinder.getRangeInches();
    	double rightDistance = starboardRangeFinder.getRangeInches();
    	double forwardDistance = forwardRangeFinder.getRangeInches();
