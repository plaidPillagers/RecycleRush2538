...
public class OI {
    ...
    public OI() {
        ...
        liftActuatorButton = new JoystickButton(secondaryStick, 15);
        ...
        ejectOnly = new JoystickButton(secondaryStick, 14);
        ...
        stopButton = new JoystickButton(secondaryStick, 14);
        ...
        intakeToggleButton = new JoystickButton(secondaryStick, 11);
        intakeToggleButton.whenPressed(new IntakeWheelsToggle());
        liftAndRetractButton = new JoystickButton(secondaryStick, 4);
        liftAndRetractButton.whenPressed(new LiftAndRetract());
        manualStackThingButton = new JoystickButton(secondaryStick, 3);
        manualStackThingButton.whenPressed(new ManualStackThingGroup());
        tridentActuatorButton = new JoystickButton(secondaryStick, 2);
