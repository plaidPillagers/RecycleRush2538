...
public class OI {
    ...
    public OI() {
        ...
        intakeWheelsOnly = new JoystickButton(secondaryStick, 1);
        intakeWheelsOnly.whileHeld(new RunIntake());
        ejectOnly = new JoystickButton(secondaryStick, 11);
        ...
        liftAndRetractButton = new JoystickButton(secondaryStick, 1);
