...
public class OI {
    ...
    public OI() {
        ...
        testEncoderRateButton = new JoystickButton(secondaryStick, 1);
        testEncoderRateButton.whenPressed(new testEncoderRate());
        diagnostics = new JoystickButton(secondaryStick, 13);
        diagnostics.whenPressed(new DisplayRangeFinder());
        getThingButton = new JoystickButton(secondaryStick, 12);
        getThingButton.whenPressed(new GetThing());
        stackThingButton = new JoystickButton(secondaryStick, 11);
        stackThingButton.whenPressed(new StackThing());
        tridentActuatorButton = new JoystickButton(secondaryStick, 10);
        tridentActuatorButton.whenPressed(new tridentActuator());
        liftActuatorButton = new JoystickButton(secondaryStick, 9);
        liftActuatorButton.whenPressed(new liftActuator());
        intakeWheelsOnly = new JoystickButton(secondaryStick, 8);
        intakeWheelsOnly.whileHeld(new RunIntake());
        ejectOnly = new JoystickButton(secondaryStick, 7);
        ejectOnly.whileHeld(new eject());
        spinClockwiseButton = new JoystickButton(secondaryStick, 6);
        spinClockwiseButton.whileHeld(new SpinClockwiseCommand());
        spinCounterClockwiseButton = new JoystickButton(secondaryStick, 5);
        spinCounterClockwiseButton.whileHeld(new SpinCounterClockwiseCommand());
        stopButton = new JoystickButton(secondaryStick, 4);
        ...
        containerLiftButton = new JoystickButton(secondaryStick, 2);
        containerLiftButton.whenPressed(new ContainerLift());
        liftAndRetractButton = new JoystickButton(secondaryStick, 16);
