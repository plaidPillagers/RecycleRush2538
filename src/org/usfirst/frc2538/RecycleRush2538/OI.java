...
public class OI {
    ...
    public OI() {
        ...
        spinClockwiseButton = new JoystickButton(secondaryStick, 12);
        spinClockwiseButton.whileHeld(new SpinClockwiseCommand());
        liftAndRetractButton = new JoystickButton(secondaryStick, 11);
        liftAndRetractButton.whenPressed(new LiftAndRetract());
        diagnostics = new JoystickButton(secondaryStick, 8);
        diagnostics.whenPressed(new DisplayRangeFinder());
        containerLiftButton = new JoystickButton(secondaryStick, 4);
        ...
        spinCounterClockwiseButton = new JoystickButton(secondaryStick, 2);
