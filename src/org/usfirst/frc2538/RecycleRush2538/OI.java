...
public class OI {
    ...
    public JoystickButton containerConfigButton;
    public JoystickButton toteConfigButton;
    ...
    public OI() {
        ...
        balancedButton = new JoystickButton(secondaryStick, 10);
        balancedButton.whenPressed(new SetBalanced());
        aftHeavyButton = new JoystickButton(secondaryStick, 12);
        aftHeavyButton.whenPressed(new SetAft());
        forwardHeavyButton = new JoystickButton(secondaryStick, 8);
        forwardHeavyButton.whenPressed(new SetForward());
        toteConfigButton = new JoystickButton(secondaryStick, 6);
        toteConfigButton.whenPressed(new toteConfig());
        containerConfigButton = new JoystickButton(secondaryStick, 5);
        containerConfigButton.whenPressed(new containerConfig());
        tridentActuatorButton = new JoystickButton(secondaryStick, 4);
        ...
        stopButton = new JoystickButton(driveStick, 2);
        stopButton.whenPressed(new stop());
        spinButton = new JoystickButton(driveStick, 5);
