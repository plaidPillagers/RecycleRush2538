 ...
 *
 */
public class  WaitForLift extends Command {
    ...
    protected boolean isFinished() {
    	if (Robot.lift.liftingActuatorRaised && timer.getElapsedTime() > 2500) {
			return true;
		}
    	else if(!Robot.lift.liftingActuatorRaised && timer.getElapsedTime() > 250 ){
			return true;
		}
        return false;
    }
