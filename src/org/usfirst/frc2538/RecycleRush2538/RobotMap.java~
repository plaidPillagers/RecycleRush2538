...
public class RobotMap {
    ...
    public static Encoder testtestEncoder;
    public static Relay lEDRed;
    public static Relay lEDGreen;
    public static Relay lEDBlue;
    ...
    public static void init() {
        ...
        intakefirstToteSwitch = new DigitalInput(0);
        ...
        lEDRed = new Relay(0);
        LiveWindow.addActuator("LED", "Red", lEDRed);
        
        lEDGreen = new Relay(1);
        LiveWindow.addActuator("LED", "Green", lEDGreen);
        
        lEDBlue = new Relay(2);
        LiveWindow.addActuator("LED", "Blue", lEDBlue);
